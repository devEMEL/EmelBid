...
contract BaseTest is Test, Deployers {
    ...
    function deployCurrencyPair(address _to) internal virtual override returns (Currency currency0, Currency currency1) {
        (currency0, currency1) = super.deployCurrencyPair(_to);
